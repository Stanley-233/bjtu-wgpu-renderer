...
#if defined _MSC_VER
#    pragma detect_mismatch("include.version", ENTT_VERSION)
#    pragma detect_mismatch("include.noexcept", ENTT_XSTR(ENTT_TRY))
#    pragma detect_mismatch("include.id", ENTT_XSTR(ENTT_ID_TYPE))
#    pragma detect_mismatch("include.nonstd", ENTT_XSTR(ENTT_NONSTD))
#endif
